...
class Autoloader
{
	...
	public function setMode($mode) {
		...
		if ($this->isRegistered()) {
			throw new \LogicException("Cannot change autoloader mode - already registered.");
		}
	...
	public function setPsr0() {
		return $this->setMode(static::PSR_0);
	}

	public function setPsr4() {
		return $this->setMode(static::PSR_4);
	}
