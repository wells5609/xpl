...
class Server {
	...
	/**
	 * @var \xpl\Component\Http\Server\RequestHeaders
	 */
	protected $headers;
	
	/**
	 * @var \xpl\Component\Http\Server\Streams
	 */
	protected $streams;
	
	/**
	 * @var \xpl\Component\Http\Server\Server
	 */
	 ...
	 * 
	 * @return \xpl\Component\Http\Server\Server
	 */
