...
abstract class Resource implements DispatchableInterface
{
	...
	public static function createFromClass($class) {
		...
		if (! is_subclass_of($class, 'xpl\\Component\\Routing\\Resource')) {
			$msg = "Resource class '$class' must implement 'xpl\\Component\\Routing\\Resource'.";
	 ...
	 * @return mixed
	 */
	public function dispatch($http_method, $match_uri) {
