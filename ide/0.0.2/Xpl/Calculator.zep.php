...
class Calculator
{
     ...
     * @param string $left 
     */
	public static function sqrt($left) {}
     ...
     *
     * @param bool is_sample [Optional] Set true if given a sample of the population (otherwise assumes data
     ...
     */
	public static function stddev($values, $is_sample = false) {}
